  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full space-y-8">
        <div>
          <h2 className="mt-1 text-center text-3xl font-extrabold text-gray-900">My Profile</h2>
          {message && <p className="mt-2 text-center text-sm text-green-600">{message}</p>}
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900">My Billing Information</h3>
              <div className="mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">My Shipping Information</h3>
              <div className="mb-4">
